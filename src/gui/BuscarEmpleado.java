...
AudioConHilos exit = new AudioConHilos("/sonidos/WExit.wav");
    ...
    private void jbtnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnAgregarActionPerformed
        try {
            select.run();
            FacturaGUI.jtxtIdempleado.setText(jtblRegistros.getValueAt(jtblRegistros.getSelectedRow(),0).toString());
            FacturaGUI.jtxtNombempl.setText(jtblRegistros.getValueAt(jtblRegistros.getSelectedRow(),1).toString());
