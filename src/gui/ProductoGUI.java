...
public class ProductoGUI extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 41, 390, 110));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 149, 390, 160));
    ...
    private void jbtnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnGrabarActionPerformed
        try {
            ...
            objProductoTO.setNombprod(jtxtNombre.getText().toUpperCase());
            objProductoTO.setPrecprod(Double.parseDouble(jtxtPrecio.getText()));
            objProductoTO.setObsvprod(jtxtObservacion.getText().toUpperCase());
            if (sw) {
        ...
        try {
            ...
            do {
                if (xidproducto == rsProducto.getInt(1)) {
                    ...
                    jtxtPrecio.setText(rsProducto.getString(3));
